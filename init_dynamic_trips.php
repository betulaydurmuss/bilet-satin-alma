...
echo "Initializing dynamic trip system...\n";
...
echo "   Inserted $inserted_count new cities.\n";

echo "3. Verifying companies exist...\n";
...
echo "4. Generating trips between all cities...\n";
...
echo "Dynamic trip system initialization completed successfully!\n";
echo "You now have trips between all 81 Turkish provinces with 3 departure times per day for 30 days.\n";
?>