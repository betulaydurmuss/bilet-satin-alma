...
echo "Setting up all 81 Turkish provinces...\n";
...
if ($count['count'] >= 81) {
    echo "✓ All 81 Turkish provinces are now available!\n";
    
    echo "\nCities successfully set up. Both departure and arrival dropdowns now include all 81 Turkish provinces:\n";
